...
namespace rtmiddleware {
	...
	RenderRTCRTP::RenderRTCRTP(QGraphicsScene* scene, RTC_MainWindow* mainwindow, RTC_XML::RTC_ProfileRTP* comp, QWidget* parent)
		...
		current_state(RTC_XML::RTC_ProfileRTP::RTC_State::RTP_Created),
		_comp(comp)
	{
	...
	void RenderRTCRTP::check_rtc()
	{
		...
		*/
		if (_comp != NULL)
		{
			...
			RTC_XML::RTC_ProfileRTP::RTC_State status = RTC_XML::RTC_ProfileRTP::RTC_State::RTP_Created;
			updateStatus(status);
			...
			{
				current_state = state;
				if (state == RTC_XML::RTC_ProfileRTP::RTC_State::RTP_InActive)
				{
				...
				else if (state == RTC_XML::RTC_ProfileRTP::RTC_State::RTP_Acitve)
				{
				...
				else if (state == RTC_XML::RTC_ProfileRTP::RTC_State::RTP_Error)
				{
